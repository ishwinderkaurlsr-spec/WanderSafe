...
const quickQuestions = [
  "What to wear in Tokyo temples?",
  "Modest outfit for Marrakech medina?",
  "Evening outfit for Paris dinner?",
  "Beach-to-city outfit in Bali?",
  "Hot weather outfit for Bangkok?",
  "What to pack for Iceland?",
];

const OutfitAdvisorPage = () => {
  const navigate = useNavigate();
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I'm your AI Outfit Advisor 👗\n\nTell me your destination, activities, and weather — I'll suggest culturally appropriate, safe, and stylish outfits across **30 destinations worldwide**!" },
  ]);
    ...
    <div className="flex flex-col h-full">
      <div className="px-5 pt-2 pb-4 flex items-center gap-3 border-b border-border">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-sm font-heading font-bold">AI Outfit Advisor</h1>
      ...
      <div className="px-5 pb-4 flex gap-2">
        <Input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === "Enter" && input && !isLoading && sendMessage(input)} placeholder="Ask about outfits..." className="rounded-xl text-sm" disabled={isLoading} />
